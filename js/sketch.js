...
function openLink(){
  if (storyCounter == 7){
    window.open("https://jmonk603.github.io/DAndDARWinPixRng/");
    window.location.href = ('https://jmonk603.github.io/DAndDExperienceP4Rng/');
  }
  if (storyCounter == 9){
    window.open("https://jmonk603.github.io/DAndDARLosePixRng/");
    window.location.href = ('https://jmonk603.github.io/DAndDExperienceP4Rng/');
  }
  if (storyCounter == 17){
    window.open("https://jmonk603.github.io/DAndDARLosePixRng/");
